...
Pod::Spec.new do |s|
  ...
  s.description  = "KSImageCarousel support both finite and infinite scrolling mode. Just init KSImageCarousel with your desire UIImages or image URLs and it will do all the work for you. KSImageCarousel can also easily adapt to different type of image source othe than UIImage and image URL"
